...
def create_alternate_lines(width, height):
    ...
    for i in range(height):
        for j in range(width):
            if i % 2 == 0:
                im.putpixel((j, i), (255, 255, 255))  # turns it to white
            else:
                im.putpixel((j, i), (0, 0, 0))  # turns it to black
...
def decode_image():
    ...
    for i in range(im.height):
        for j in range(im.width):
            (r, g, b) = im.getpixel((j, i))
            if r % 2 == 0:
                im_secret.putpixel((j, i), (255, 0, 0))  # turns it to red
            else:
                im_secret.putpixel((j, i), (0, 0, 0))  # turns it to black
